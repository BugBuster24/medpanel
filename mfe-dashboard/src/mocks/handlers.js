...
import { mockStats, mockPatients, mockAppointments, mockAdmissionTrend, mockDepartmentData, } from "./data";
export const handlers = [
    ...
    http.get("/api/admissions/trend", () => HttpResponse.json(mockAdmissionTrend)),
