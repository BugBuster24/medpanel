...
import { DashboardStats } from 'shared-lib';
  ...
  return (
    <div style={{ padding: '24px' }}>
      ...
      <div style={{
        ...
        <StatCard title="Total Patients" value={stats?.totalPatients ?? 0} color="indigo" />
        <StatCard title="Appointments Today" value={stats?.appointmentsToday ?? 0} color="green" />
        <StatCard title="Beds Available" value={stats?.bedsAvailable ?? 0} color="orange" />
        <StatCard title="Beds Occupied" value={stats?.bedsOccupied ?? 0} color="red" />
      </div>
